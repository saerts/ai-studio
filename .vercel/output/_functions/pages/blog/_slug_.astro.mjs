...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BlogLayout", $$BlogLayout, { "post": post, "isMCPPost": isMCPPost }, { "default": async ($$result2) => renderTemplate`${isMCPPost ? renderTemplate`${maybeRenderHead()}<div class="prose prose-invert prose-lg max-w-none"> ${renderComponent($$result2, "SafeHTML", $$SafeHTML, { "content": post.body || `
...
}, "/Users/saerts/Sites/WEBMASTER/sa_LIVE/sa73/AI-Studio/ai-studio/src/pages/blog/[slug].astro", void 0);

const $$file = "/Users/saerts/Sites/WEBMASTER/sa_LIVE/sa73/AI-Studio/ai-studio/src/pages/blog/[slug].astro";
const $$url = "/blog/[slug]";
